...
@property (nonatomic, readwrite) RulesInformationEdgeViewController* vc1;
@property (nonatomic, readwrite) RulesInformationCloudViewController* vc2;
...
- (void)viewDidLoad {
    ...
    self.vc1 = [self.storyboard instantiateViewControllerWithIdentifier:@"RulesInformationEdgeViewControllerIdentifier"];
    self.vc2 = [self.storyboard instantiateViewControllerWithIdentifier:@"RulesInformationCloudViewControllerIdentifier"];
